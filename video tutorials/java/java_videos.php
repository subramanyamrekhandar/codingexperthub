...
<nav class="navbar navbar-expand-lg navbar-light bg-primary fixed-top">
  <a class="navbar-brand text-white" href="#">CodingExperthub</a>
...
<br><br>
		...
		<div class='commentdiv shadow bg-info' style="border:1px #d2c8c8 solid; background-color: #7b9ac7;">
<?php  
...
getComments($con);
 ...
 ?>
  ...
  <table class="table table-hover mt-3 table-borderless bg-light">
    <tbody>
	<div class="card-header text-center bg-info"><h5>Popular videos</h5></div>
